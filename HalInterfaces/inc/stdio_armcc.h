...
#pragma __printf_args
#if 0
extern _ARMABI int printf(format, ...)		do{iDebugPrint(DBG_LEV_NO, format, ##__VA_ARGS__);}while(0);
#else
extern _ARMABI int printf(format, ...)		do{iDebugPrint(DBG_LEV_VERBOSE, format, ##__VA_ARGS__);}while(0);
#endif
   /*
